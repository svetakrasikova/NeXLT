...
rm -f /local/cms/javaDBLink/athena2nexlt/*.csv
cd /local/cms/javaDBLink/athena2nexlt
java -cp /local/cms/javaDBLink/bzip2.jar:/local/cms/javaDBLink/opencsv-2.3.jar:/local/cms/javaDBLink/oracle_11203_ojdbc6.jar:/local/cms/javaDBLink AthenaExportMt jdbc:oracle:thin:@oracmsprd1.autodesk.com:1521:CMSPRD1 cmsuser Ten2Four ALL $(date --date yesterday +%Y.%m.%d) $(date +%Y.%m.%d) 0 1
